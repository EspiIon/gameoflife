...
GameOfLife: raylib
ifneq (,$(GameOfLife_config))
	@echo "==== Building GameOfLife ($(GameOfLife_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f GameOfLife.make config=$(GameOfLife_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f GameOfLife.make clean
